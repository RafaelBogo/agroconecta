...
<style>
  ...
  .option-icon {
    ...
    place-items: center;
    border-radius: 50%;
    background: linear-gradient(180deg, #e8f5ee, #d5efe3); /* fundo claro com verde suave */
    border: 1px solid rgba(25, 135, 84, 0.25);
  }

  .option-icon i {
    font-size: 1.6rem;
    color: #198754; /* verde padrão Bootstrap */
  }
...
<div class="account-container">
  ...
  <div class="options-grid">
    ...
    <a href="<?php echo e(route('seller.mySales')); ?>" class="option-card" aria-label="Minhas Vendas">
