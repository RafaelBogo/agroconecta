    ...
    <div class="product-wrap">
        ...
        <div>
            <div class="product-image mb-4">
                <img src="<?php echo e($foto); ?>" alt="Foto do produto <?php echo e($product->name); ?>"
        ...
        <div>
            ...
            <?php else: ?>
                ...
                <form id="add-to-cart-form" class="mb-3" data-cart-add-url="<?php echo e(route('cart.add')); ?>"
                    data-login-url="<?php echo e(route('login')); ?>" data-product-id="<?php echo e($product->id); ?>">
                    <label for="quantity" class="form-label">Quantidade</label>
                    <input type="number" id="quantity" name="quantity" class="form-control" value="1"
                        min="<?php echo e($decimais ? '0.01' : '1'); ?>" step="<?php echo e($decimais ? '0.01' : '1'); ?>" inputmode="decimal" required>
