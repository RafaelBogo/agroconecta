    ...
    <?php $__env->startSection('back', content: route('myAccount')); ?>
        ...
        <?php $__empty_1 = true; $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="rating-card mb-3">
                ...
                <?php if (! (in_array($product->id, $reviews))): ?>
                    <form action="<?php echo e(route('products.reviews.store', $product->id)); ?>" method="POST" class="mt-3 rating-form"
                        id="form-<?php echo e($product->id); ?>">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="mt-3">
                            ...
                            <textarea id="comment-<?php echo e($product->id); ?>" name="comment" class="form-control" rows="2"
