...
<style>
    ...
    .status-processando{ background:#fff7ed; color:#9a3412; border-color:#fed7aa; }   /* laranja claro */
    .status-confirmado{ background:#eff6ff; color:#1d4ed8; border-color:#bfdbfe; }    /* azul */
    .status-enviado{ background:#ecfeff; color:#0369a1; border-color:#bae6fd; }       /* ciano */
    .status-entregue{ background:#ecfdf5; color:#065f46; border-color:#bbf7d0; }      /* verde */
    .status-cancelado{ background:#f3f4f6; color:#374151; border-color:#e5e7eb; }     /* cinza */
...
(function(){
    ...
    function startCountdown(){
        document.querySelectorAll('.cancel-timer').forEach(timer => {
            ...
            // Se não estiver processando, o timer não se aplica
            ...
            const iv = setInterval(() => {
                ...
                if(timeLeft > 0){
                    ...
                    clearInterval(iv);
                    spanVal.textContent = 'Tempo para cancelamento expirado.';
                    // Remove botão cancelar do respectivo card
