...
<?php
    $cities = [
        'Chapecó','Xanxerê','Xaxim','Pinhalzinho','Palmitos','Maravilha','Modelo','Saudades',
        'Águas de Chapecó','Nova Erechim','Nova Itaberaba','Coronel Freitas','Quilombo','Abelardo Luz',
        'Coronel Martins','Galvão','São Lourenço do Oeste','Campo Erê','Saltinho','São Domingos','Ipuaçu',
        'Entre Rios','Jupiá','Itapiranga','Iporã do Oeste','Mondaí','Riqueza','Descanso','Tunápolis','Belmonte',
        'Paraíso','São Miguel do Oeste','Guaraciaba','Anchieta','Dionísio Cerqueira','Barra Bonita'
    ];
    ...
    $isUrl = $rawPhoto && (str_starts_with($rawPhoto, 'http://') || str_starts_with($rawPhoto, 'https://'));
    $fotoAtual = $isUrl ? $rawPhoto : url('storage/' . ltrim($rawPhoto, '/'));
        ...
        <div class="card border-0 shadow-sm h-100">
            <div class="card-body">
                ...
                <div class="mb-3 text-center">
                    <img src="<?php echo e($fotoAtual); ?>" alt="<?php echo e($product->name); ?>"
                         class="img-fluid rounded mb-3 shadow-sm"
                         onerror="this.onerror=null;this.src='<?php echo e($fotoFallback); ?>';">
                </div>
                ...
                <div class="mb-3">
                    ...
                    <textarea id="description" name="description" class="form-control" rows="3" required><?php echo e(old('description', $product->description)); ?></textarea>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input id="price" type="number" step="0.01" name="price"
                               class="form-control" value="<?php echo e(old('price', $product->price)); ?>" required>
                    </div>
                    <div class="col-md-6 mb-3">
        ...
        <div class="card border-0 shadow-sm h-100">
            <div class="card-body d-flex flex-column">
                ...
                <div class="pt-2 d-flex gap-2 justify-content-end mt-auto">
                    <a href="<?php echo e(route('account.myProducts')); ?>" class="btn btn-outline-secondary">
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script>
        // mostra/esconde unidade personalizada
