   ...
   <nav class="navbar navbar-expand-lg navbar-dark fixed-top">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav nav-center my-2 my-lg-0">
                <li class="nav-item"><a class="nav-link" href="<?php echo e(route('dashboard')); ?>">Início</a></li>
                <li class="nav-item"><a class="nav-link" href="<?php echo e(route('products.show')); ?>">Produtos</a></li>
                <li class="nav-item"><a class="nav-link" href="<?php echo e(route('sell.cadastroProduto')); ?>">Vender</a></li>
                <li class="nav-item"><a class="nav-link" href="<?php echo e(route('chat.inbox')); ?>">Mensagens</a></li>
                <li class="nav-item"><a class="nav-link" href="<?php echo e(route('cart.view')); ?>">Carrinho</a></li>
            </ul>


            <ul class="navbar-nav ms-lg-auto">
                <li class="nav-item"><a class="nav-link px-lg-3" href="<?php echo e(route('minha.conta')); ?>">Minha Conta</a></li>
                <li class="nav-item">
    ...
    <footer class="site-footer mt-auto pt-5 pb-4" role="contentinfo">
        <div class="container">
            ...
            <div class="col-6 col-lg-3">
                ...
                <li><a href="<?php echo e(route('minha.conta')); ?>">Minha Conta</a></li>
                </ul>
            </div>
...
</html><?php /**PATH C:\xampp\htdocs\agroconecta\resources\views/layouts/app.blade.php ENDPATH**/ ?>