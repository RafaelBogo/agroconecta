...
<?php $__env->startSection('content'); ?>
    ...
    <?php if($products->isEmpty()): ?>
        <div class="empty-state text-center py-5">
            ...
            <a href="<?php echo e(route('sell.cadastroProduto')); ?>" class="btn btn-success">
    ...
    <?php else: ?>
        <div class="d-flex align-items-center justify-content-between mb-3">
            <h4 class="m-0">
                Produtos em venda
                <span class="text-muted">(<?php echo e($products->count()); ?>)</span>
            </h4>
            <a href="<?php echo e(route('sell.cadastroProduto')); ?>" class="btn btn-success">
        ...
        <div class="products-grid">
            <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="product-card">
                    <div class="thumb">
                        <img loading="lazy" src="<?php echo e($foto); ?>" alt="<?php echo e($product->name); ?>"
                    ...
                    <div class="middle">
                        ...
                        <div class="meta mt-1">
                            ...
                            <?php if($product->city): ?>
                                <span class="badge rounded-pill bg-light text-dark">
                                    <i class="bi bi-geo-alt me-1"></i> <?php echo e($product->city); ?>
    ...
    <a href="<?php echo e(route('myAccount')); ?>" class="btn-voltar mt-3">
