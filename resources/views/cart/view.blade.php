    ...
    <div class="cart-content">
                                ...
                                <td class="quantity-controls">
                                    <div class="input-group" style="max-width: 140px;">
                                        ...
                                        <input type="number" step="0.01" min="0.01"
                                            class="form-control text-center quantity-input no-spin" readonly
        ...
        <div class="cart-summary">
            ...
            <button class="btn btn-success btn-finalize" id="finalizarPedido">
                ...
                <span id="finalizarSpinner" class="spinner-border spinner-border-sm" role="status" aria-hidden="true"
